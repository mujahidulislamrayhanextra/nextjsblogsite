...
const handleCancelUploadImg  = () => {
    ...
    return (
       <section className="container max-w-3xl" >
            <h2 className="mb-5">
                <span className="special-word">Edit</span>Blog </h2>
                   ...
                   <option value="Gamebirds">Gamebirds</option>
                    ...
                    <div>
...

                      {
                        state.newImage ? (
                            <div>
                                 <Image src={URL.createObjectURL(state.newImage)} priority alt="Sampleimage" width={200} height={200} sizes="100vw" className=" w-32 mt-5"/>
                      ...
                      state.photo && state.photo["url"] && (
                        <div>
                             <Image src={state.photo.url} priority alt="Sampleimage" width={200} height={200} sizes="100vw" className=" w-32 mt-5"/>
                        </div>
                      )
                    }
                                </div>
